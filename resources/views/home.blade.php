...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="AdminLTE-3/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="AdminLTE-3/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="AdminLTE-3/dist/img/user1-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="AdminLTE-3/dist/img/user3-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="AdminLTE-3/dist/img/user1-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="AdminLTE-3/dist/img/user7-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="AdminLTE-3/dist/img/user3-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="AdminLTE-3/dist/img/user5-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="AdminLTE-3/dist/img/user6-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="AdminLTE-3/dist/img/user8-128x128.jpg" alt="User Avatar">
...
<!-- Sparkline -->
<script src="AdminLTE-3/plugins/sparklines/sparkline.js"></script>
<!-- JQVMap -->
